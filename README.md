==============================================================================
PROJECT: VISION SHOP ASSISTANT (Group Project)
AI-Powered Shopping Assistant for the Visually Impaired
==============================================================================

OVERVIEW
--------
This is a full-stack AI application that uses:
1. FRONTEND: React + TypeScript (Mobile Interface)
2. BACKEND: Python + Flask + YOLOv8 (Computer Vision)

The system detects grocery items in real-time via the camera, announces them 
using Text-to-Speech, and calculates the total cost for the user.
...
3. A Webcam (if on laptop) or WiFi connection (if testing on mobile)
...
- "Camera Access Denied": 
  Ensure you are using the HTTPS link, not HTTP. Browsers block cameras on insecure HTTP.

- "Nothing Detected": 
  Check Terminal 1. If it is frozen, your phone might have lost connection to the server. 
  Restart the server and check your IP address in 'src/services/yoloService.ts'.
...
- /src/services/    : Contains yoloService (Vision) and ttsService (Voice).
